    ...
    >
      {variant === 'one' ? (
        <>
          ...
          >
            <span className="bg-primary-500 bg-primary text-white px-2 py-1 rounded">
              New
            </span>
          ...
          >
            ...
            <Button className="w-1/3 text-xs mt-2 border-[1px] bg-transparent border-gray-400 px-4 py-2 hover:bg-primary text-primary-typography">
              Buy Now
            </Button>
          </motion.div>
        </>
